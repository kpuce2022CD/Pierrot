...
class CourtReference:
    ...
    def __init__(self): # 점의 위치를 x,y좌표로 표현        
        ...
        #각 court_configuration 파일의 이미지의 좌표를 표현하기 위한 수식을 사용하기 위해 리스트로 나열해 놓은것
    ...
    def get_court_mask(self, mask_type=0):
        ...
        if mask_type == 1:  # 코트 밑부분 절반
            mask[:self.net[0][1] - 1000, :] = 0
        elif mask_type == 2:  # 코트 윗부분 절반
            mask[self.net[0][1]:, :] = 0
        elif mask_type == 3:  # 모서리 제외 코트
