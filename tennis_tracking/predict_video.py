...
#     output_video_path = input_video_path.split(
#         '.')[0] + "VideoOutput/video_output.avi"
...
while (True):
    ...
    print('Percentage of video processed : {}'.format(
        round((currentFrame / total) * 100, 2)))
    ...
    #     cv2.circle(
    #         output_img, (centroid_player[0], centroid_player[1]), 1, (0, 255, 0), 2)
